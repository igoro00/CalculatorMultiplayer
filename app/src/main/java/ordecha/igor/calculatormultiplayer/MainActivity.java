...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isMP) {
            ...
            Button buttonPapa = findViewById(R.id.buttonPapa);
            buttonPapa.setOnLongClickListener(new View.OnLongClickListener() {
                public boolean onLongClick(View v) {
                    ...
                    final EditText Write = sendTxtDialog.findViewById(R.id.write);
                    Button SendTxt = sendTxtDialog.findViewById(R.id.sendButton);
